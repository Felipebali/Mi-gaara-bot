...
✨ _“Un maullido, una acción.”_
    ...
    // 🔘 BOTONES
    const buttons = [
      { buttonId: '.menuser', buttonText: { displayText: '👤 Menú Usuario' }, type: 1 },
      { buttonId: '.menuj', buttonText: { displayText: '🎮 Juegos' }, type: 1 },
      { buttonId: '.menuowner', buttonText: { displayText: '👑 Owner' }, type: 1 }
    ];
